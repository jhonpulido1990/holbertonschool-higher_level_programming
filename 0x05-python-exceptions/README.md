...
## Details
      By Guillaume          Weight: 1              Project over - took place from 01-17-2022 to 01-18-2022          - you're done with 100% of tasks.              An auto review will be launched at the deadline      #### In a nutshell…
* Auto QA review:          84.0/84 mandatory            &            9.0/51 optional      
* Altogether:         117.65%* Mandatory: 100.0%
* Optional: 17.65%
*               Calculation:                   100.0%                    + (100.0% * 17.65%)               == 117.65%
...
* File:  ` 5-raise_exception.py ` 
 Self-paced manual review  Panel footer - Controls 
### 6. Raise a message
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that raises a name exception with a message.
...
### 7. Safe integer print with error message
          #advanced         Progress vs Score           Score: 64.29% (Checks completed: 64.29%)         Task Body Write a function that prints an integer.
